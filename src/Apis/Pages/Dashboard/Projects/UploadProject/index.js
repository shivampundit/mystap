            ...
            <div className="col-md-12 text-start">
              <div className="upload-main">
                ...
                <div className="boxes d-flex justify-content-between">
                  ...
                  <div className="boxs-upload upload-three" id="upload-three">
